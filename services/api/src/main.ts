...
async function bootstrap() {
  ...
  // Serve os arquivos de `uploads/` (modo simulado de storage — ver
  // document-verification/storage/local-disk.adapter.ts) publicamente
  // em /uploads, fora do prefixo /api/v1 (mesmo padrao do health check).
