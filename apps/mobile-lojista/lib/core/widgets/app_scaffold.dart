...
/// Scaffold base do app GIUCAR Cyberpunk (Portal do Lojista).
///
/// Fornece:
...
/// - navegacao inferior flutuante (Home / Produtos / Pedidos / Perfil)
...
class _FloatingNavBar extends StatelessWidget {
  ...
  static const _items = [
    ...
    (icon: Icons.inventory_2_rounded, label: 'Produtos'),
