...
/// Excecao amigavel para erros de rede/API, para ser exibida diretamente
/// na UI sem vazar detalhes tecnicos do Dio/HTTP.
class ApiException implements Exception {
  ...
  /// True quando o erro foi de conectividade (sem resposta do servidor),
  /// util para a UI mostrar um estado "offline" em vez de erro generico.
