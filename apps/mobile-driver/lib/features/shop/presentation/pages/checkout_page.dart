...
/// (um por loja) -> pagamento (mock) de cada um. Mesmo fluxo do app
/// cliente, reaproveitando o mesmo `POST /marketplace/client/checkout`
/// (agnostico ao role do comprador).
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(
                _step == 0
                    ? 'Passo 1 de 2 · Endereço de entrega'
              ...
              children: [
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    style: const TextStyle(color: AppColors.textPrimary),
                    decoration:
                        const InputDecoration(labelText: 'UF', counterText: ''),
                    validator: (v) =>
