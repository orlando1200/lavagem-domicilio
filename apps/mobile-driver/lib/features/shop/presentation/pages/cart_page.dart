...
/// Tela de carrinho — resumo dos itens, segue para `/shop/checkout`
/// (endereco + pagamento real) ao finalizar.
...
class _CartItemCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final color =
        item.product.id.hashCode.isEven ? AppColors.primary : AppColors.accent;
