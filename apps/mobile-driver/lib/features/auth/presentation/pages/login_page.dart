...
/// Tela de login GIUCAR Pro (area do lavador).
///
...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Future<void> _submit() async {
    ...
    await ref.read(driverAuthProvider.notifier).login(
          _emailController.text.trim(),
          _passwordController.text,
        );
    if (!mounted) return;
    final state = ref.read(driverAuthProvider);
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = authState is DriverAuthLoading;
                            ...
                            children: [
                              ...
                              FilledButton(
                                ...
                                child: isLoading
                                    ...
                                    : const Text('Entrar como lavador'),
                              ),
