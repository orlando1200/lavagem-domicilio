...
/// Scaffold base do app GIUCAR Cyberpunk (Lavador).
///
/// Fornece:
...
class AppScaffold extends StatelessWidget {
  ...
  /// Callback do item "Entregas" da nav bar. Como a tela de entregas da
  /// Loja do Lavador vive fora do IndexedStack de tabs (Home/Pedidos/
  /// Perfil), ela e aberta via `push` em vez de trocar o `currentIndex`.
          ...
          if (showNavBar && currentIndex != null)
            Positioned(
              ...
              child: _FloatingNavBar(
                ...
                onDeliveriesTap: onDeliveriesTap,
              ),
            ),
        ],
      ),
...
class _FloatingNavBar extends StatelessWidget {
  ...
  static const _items = [
    ...
    (icon: Icons.local_shipping_rounded, label: 'Entregas'),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: List.generate(_items.length, (i) {
          // Item "Entregas" (indice 2) e uma tela fora do IndexedStack de
          // tabs: abre via push e nunca fica marcado como selecionado.
          final isDeliveries = i == 2;
          final item = _items[i];
          if (isDeliveries) {
            return _NavItem(
              icon: item.icon,
          ...
          return _NavItem(
            ...
            onTap: () => onDestinationSelected?.call(tabIndex),
          );
        }),
      ),
    );
